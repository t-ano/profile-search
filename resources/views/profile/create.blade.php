            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('profile.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            <label>プロフィール</label>
                            <textarea class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="summary" cols="30" rows="7"></textarea>
                        </div>
